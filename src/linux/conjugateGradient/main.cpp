...
{
    int M = 1048576, N = 1048576, nz = 0, *I = NULL, *J = NULL;
    float *val = NULL;
	...
	{
		M = N = getCmdLineArgumentInt(argc, (const char **)argv, "N");
	}
    ...
    cusparseSpMV(cusparseHandle, CUSPARSE_OPERATION_NON_TRANSPOSE, &alpha, descr, d_val, d_row, d_col, d_x, &beta, d_Ax);
