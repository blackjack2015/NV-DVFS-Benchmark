...
int compute_tran_temp(float *MatrixPower,float *MatrixTemp[2], int col, int row, \
		int pyramid_height, int blockCols, int blockRows, int borderCols, int borderRows)
{
	...
	while (k < nIter)
	{
		...
		//	calculate_temp << <dimGrid, dimBlock >> >(MIN(pyramid_height, nIter - t), MatrixPower, MatrixTemp[src], MatrixTemp[dst], \
					//			col,row,borderCols, borderRows, Cap,Rx,Ry,Rz,step,time_elapsed);
		calculate_temp << <dimGrid, dimBlock >> >(pyramid_height, MatrixPower, MatrixTemp[src], MatrixTemp[dst], \
